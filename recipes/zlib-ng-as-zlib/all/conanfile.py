...
class ZlibNgConan(ConanFile):
    #sleight of hand here. We need other packages dependent on zlib to think this is the real zlib
    name = "zlib"
    ...
    #default zlib_compat and with_optim changed to True
    default_options = {
        "shared": False,
        "fPIC": True,
        "zlib_compat": True,
    ...
    def package_info(self):
        # Specify some names/properties here to mimic zlib
